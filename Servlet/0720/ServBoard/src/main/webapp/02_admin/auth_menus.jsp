			...
			success:function(data){
				...
				strHTML += "</tr>";
					...
					for(var topMenu of topMenus){
						...
						strHTML += "<input type='checkbox' disabled id='top" + topMenuID + "Sel' onclick='chkSelClick(&quot;" + topMenuID + "&quot;, &quot;Sel&quot;, &quot;top&quot;);' ";
						if(authSel == "Y"){strHTML += "checked";}
						strHTML += " />";
						strHTML += "</td>";
						strHTML += "<td width='8%' height='30px;' align='center'>";
						strHTML += "<input type='checkbox' disabled id='top" + topMenuID + "Up' onclick='chkSelClick(&quot;" + topMenuID + "&quot;, &quot;Up&quot;, &quot;top&quot;);' ";
						if(authUp == "Y"){strHTML += "checked";}
						strHTML += " />";
						strHTML += "</td>";
						strHTML += "<td width='8%' height='30px;' align='center'>";
						strHTML += "<input type='checkbox' disabled id='top" + topMenuID + "Ins' onclick='chkSelClick(&quot;" + topMenuID + "&quot;, &quot;Ins&quot;, &quot;top&quot;);' ";
						if(authIns == "Y"){strHTML += "checked";}
						strHTML += " />";
						strHTML += "</td>";
						strHTML += "<td width='8%' height='30px;' align='center'>";
						strHTML += "<input type='checkbox' disabled id='top" + topMenuID + "Del' onclick='chkSelClick(&quot;" + topMenuID + "&quot;, &quot;Del&quot;, &quot;top&quot;);' ";
	...
	var chkSelClick = function(selectedMenuID, colName, gbn){
		...
		if(!$("#" + selectedChkID).prop("checked")){
			...
			if(colName == "Sel"){
				...
				$("#" + gbn + selectedMenuID + "Sel").prop("checked", false);
				//$("input[id*='sub" + selectedMenuID + "']").prop("checked", false);
			}
			
			var selectedSubMenuID = selectedMenuID + colName;
				...
				success:function(data){
					...
					strHTML += "</tr>";
						...
						for(var subMenu of subMenus){
							...
							strHTML += "</td>";
							strHTML += "<td width='8%' height='30px;' align='center'>";
							strHTML += "<input type='checkbox' id='sub" + subMenuID + rootID + "Sel' onclick='chkSelClick(&quot;" + subMenuID + rootID  + "&quot;, &quot;Sel&quot;, &quot;sub&quot;);' ";
							if(authSel == "Y"){strHTML += "checked";}
							strHTML += " />";
							strHTML += "</td>";
							strHTML += "<td width='8%' height='30px;' align='center'>";
							strHTML += "<input type='checkbox' id='sub" + subMenuID + rootID + "Up' onclick='chkSelClick(&quot;" + subMenuID + rootID  + "&quot;, &quot;Up&quot;, &quot;sub&quot;);' ";
							if(authUp == "Y"){strHTML += "checked";}
							strHTML += " />";
							strHTML += "</td>";
							strHTML += "<td width='8%' height='30px;' align='center'>";
							strHTML += "<input type='checkbox' id='sub" + subMenuID + rootID + "Ins' onclick='chkSelClick(&quot;" + subMenuID + rootID  + "&quot;, &quot;Ins&quot;, &quot;sub&quot;);' ";
							if(authIns == "Y"){strHTML += "checked";}
							strHTML += " />";
							strHTML += "</td>";
							strHTML += "<td width='8%' height='30px;' align='center'>";
							strHTML += "<input type='checkbox' id='sub" + subMenuID + rootID + "Del' onclick='chkSelClick(&quot;" + subMenuID + rootID  + "&quot;, &quot;Del&quot;, &quot;sub&quot;);' ";
							if(authDel == "Y"){strHTML += "checked";}
							strHTML += " />";
							strHTML += "</td>";
							strHTML += "</tr>";
					...
					complete:function(data,textStatus){
						...
						$("input[id*='top']").attr("disabled","true");
						$("input[id*='top" + selectedMenuID + "']").removeAttr("disabled");
					}
				});
				$.ajax(ajaxObj);
