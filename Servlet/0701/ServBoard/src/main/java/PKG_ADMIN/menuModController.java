...
@WebServlet("/Admin_ModMainMenu")
public class menuModController extends HttpServlet{
	@Override
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String strModMainID = request.getParameter("modMainMenuID");
		String strModMainName = request.getParameter("modMainMenuName");
		String strModMainSeq = request.getParameter("modMainMenuSeq");
