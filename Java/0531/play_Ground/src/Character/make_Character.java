...
public class make_Character {
	...
	public void get_Sword(String wName, int wPower) {
		if(wWeapon == wName) {
			System.out.println("이미 장착한 무기입니다");
		}
		else {
			this.wWeapon = wName;
			this.STR += wPower;
	...
	public void get_Bow(String wName, int wPower) {
		if(wWeapon == wName) {
			System.out.println("이미 장착한 무기입니다");
		}
		else {
	...
	public void get_Staff(String wName, int wPower) {
		if(wWeapon == wName) {
			System.out.println("이미 장착한 무기입니다");
		}
		else {
	...
	public void get_Dagger(String wName, int wPower) {
		if(wWeapon == wName) {
			System.out.println("이미 장착한 무기입니다");
		}
		else {
